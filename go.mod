module github.com/osiloke/gostore_raft

go 1.22.0

// replace github.com/go-micro/plugins/v4/registry/nats => ../micro_plugins/v4/registry/nats
...
require (
	...
	github.com/rqlite/rqlite v0.0.0-20230420014941-c837103928a4
